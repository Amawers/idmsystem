...
offlineCaseDb.version(10).stores({
    ...
    programs: "++localId, id, updated_at, program_name, status, hasPendingWrites",
    program_queue: "++queueId, targetLocalId, targetId, operationType, createdAt",
    program_enrollments: "++localId, id, program_id, enrollment_date, status, updated_at, hasPendingWrites",
    enrollment_queue: "++queueId, targetLocalId, targetId, operationType, createdAt",
...
offlineCaseDb.version(11).stores({
    ...
    cached_vac_cases: "id, identifying_name, case_manager, status",
    cached_far_cases: "id, receiving_member, case_manager, status",
    service_delivery: "++localId, id, enrollment_id, program_id, service_date, hasPendingWrites, lastLocalChange",
    service_delivery_queue: "++queueId, targetLocalId, targetId, operationType, createdAt",
});
...
offlineCaseDb.version(12).stores({
    ...
    service_delivery: "++localId, id, enrollment_id, program_id, service_date, hasPendingWrites, lastLocalChange",
    service_delivery_queue: "++queueId, targetLocalId, targetId, operationType, createdAt",
    partners: "++localId, id, organization_name, partnership_status, mou_expiry_date, hasPendingWrites, lastLocalChange",
    partners_queue: "++queueId, targetLocalId, targetId, operationType, createdAt",
});
...
offlineCaseDb.version(13).stores({
    ...
    partners: "++localId, id, organization_name, partnership_status, mou_expiry_date, hasPendingWrites, lastLocalChange",
    partners_queue: "++queueId, targetLocalId, targetId, operationType, createdAt",
    inventory_items: "++localId, id, item_name, category, status, hasPendingWrites, lastLocalChange",
    inventory_queue: "++queueId, targetLocalId, targetId, operationType, createdAt",
});
...
offlineCaseDb.version(14).stores({
    ...
    inventory_items: "++localId, id, item_name, category, status, hasPendingWrites, lastLocalChange",
    inventory_queue: "++queueId, targetLocalId, targetId, operationType, createdAt",
    resource_requests: "++localId, id, request_number, status, priority, requested_by, hasPendingWrites, pendingAction, lastLocalChange",
    resource_requests_queue: "++queueId, targetLocalId, targetId, operationType, createdAt",
});
...
offlineCaseDb.version(15).stores({
    ...
    inventory_items: "++localId, id, item_name, category, status, hasPendingWrites, lastLocalChange",
    inventory_queue: "++queueId, targetLocalId, targetId, operationType, createdAt",
    resource_requests: "++localId, id, request_number, status, priority, requested_by, created_at, hasPendingWrites, pendingAction, lastLocalChange",
    resource_requests_queue: "++queueId, targetLocalId, targetId, operationType, createdAt",
});
