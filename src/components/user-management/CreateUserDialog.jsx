 ...
 * - Delegates creation to parent-provided callback.
 *
 * Notes:
 ...
 * @property {(payload: { fullName: string, email: string, password: string }) => Promise<any>} onCreateUser
...
export function CreateUserDialog({
	...
	/**
	 * Creates a user through the parent callback.
	 *
	...
	const onSubmit = async (data) => {
		...
		try {
			...
			if (typeof onCreateUser !== "function") {
				throw new Error("Create user handler is not configured.");
			}
