...
const programSchema = z
	.object({
		...
		budget_allocated: z.coerce
			.number()
			.min(0, "Budget must be a positive number"),
		budget_spent: z.coerce
			.number()
			.min(0, "Budget spent must be a positive number")
			.optional(),
		...
		try {
			...
			if (error.message) {
				if (error.message.includes("budget")) {
					errorMessage =
						"Budget allocated must be a valid positive number.";
						...
						<div className="space-y-4">
							...
							<div className="space-y-2">
								...
								{errors.target_beneficiary && (
									<p className="text-sm text-red-600">
										{errors.target_beneficiary.message}
									</p>
								)}
							</div>
						...
						<div className="space-y-4">
							...
							<div className="space-y-2">
								...
								<p className="text-xs text-muted-foreground">
									Select partner organizations collaborating
									on this program
									{partners && partners.length > 0 && (
										<span className="ml-1">
