-- =====================================================
-- Migration: Update Enrollment Attendance Trigger
-- Description: Updates the trigger to properly track both sessions_attended 
--              and sessions_completed based on service delivery logs
-- Date: 2025-11-11
-- =====================================================
...
-- Create or replace the trigger function with updated logic
